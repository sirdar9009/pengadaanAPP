        ...
        <div class="row">
          <div class="col-12">
            <div class="text-right mb-2">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pengadaanModal"><i class="fas fa-plus"></i>Tambah</button>
            </div>
            <div class="card">
                    ...
                    <tr>
                      ...
                      <td>
                        @if($tampil-> gambar != "")
                          ...
                          <hr>
                          <a class="konfirmasi" href="/hapusGambar/{{$tampil->id_pengadaan}}"><button class="btn-danger"><i class="fas fa-trash"></i>Hapus</button></a>
                        @endif
                        ...
                        @if($tampil-> gambar == "")
                            ...
                            <form method="post" action="/uploadGambar" enctype="multipart/form-data">
                              {{csrf_field()}}
                              <input type="hidden" name="id_pengadaan" id="id_pengadaan" value="{{$tampil->id_pengadaan}}">
                              <label  for="gambar" class=" btn btn-block btn-outline-info btn-flat">Pilih Gambar Pengadaan</label>
                      ...
                      <td>
                        <a class="konfirmasi" href="/hapusPengadaan/{{$tampil->id_pengadaan}}"><button class="btn-danger"><i class="fas fa-trash"></i>Hapus</button></a>

                        <button data-toggle="modal" data-target="#ubahModal" data-id_pengadaan="{{$tampil->id_pengadaan}}" data-nama_pengadaan="{{$tampil->nama_pengadaan}}" data-deskripsi="{{$tampil->deskripsi}}"
                        data-anggaran="{{$tampil->anggaran}}" class="btn-secondary edit"><i class="fas fa-edit"></i>Ubah</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
