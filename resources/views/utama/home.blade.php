...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <!-- cara memasukan menu.blade.php disisni-->
      @include('utama.menu')
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Kami memberikan kesempatan kepada UMKM yang ingin Mengajukan penjualan Barang atau Jasa</h2>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Memiliki Iznin Usaha</a></h4>
              <p>Bagi peserta yang ingin mengajukan wajib memiliki izin usaha</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Usaha yang dijalankan telah berjalan lebih dari 3 tahun</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Usaha yang dijalakan harus berbadan Hukum, minimal CV yang terdaftar Min 3 tahun</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Memiliki rekening atasa nama badan usaha yang dijalankan, dan terdaftar di bank BUMN</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut adalah Daftar Pengadaan yang Aktif saat ini.</p>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>Anggaran Pengadaan : Rp. {{number_format($p->anggaran,0,",",".")}}</p>

              <a href="{{$p->deskripsi}}" title="Deskripsi Pengadaan" target="_blank"><i class="bx bx-plus"></i>Lihat Deskripsi</a>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            ...
            @else
            <a class="cta-btn align-middle" href="/listSuplier">Ajukan</a>
            @endif
          </div>
        </div>
